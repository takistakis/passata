...
def split(name: Optional[str]) -> Tuple[Optional[str], Optional[str]]:
...
def to_dict(data: Optional[str]) -> Dict:
...
def to_string(data: Optional[Dict]) -> str:
...
class DB:
    ...
    def __init__(self, path, pre_read_hook=None, post_write_hook=None):
        ...
        self.pre_read_hook: Optional[Path] = pre_read_hook
